...
<%@ include file="admin_menu.jsp" %> 
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            </i><a href="/Lmonkeyshop/manage/admin_index.jsp">首页</a>
              <span class="crumb-step">&gt;</span>
              <a class="crumb-name" href="/Lmonkeyshop/manage/admin_douserselect">用户管理</a>
              <span class="crumb-step">&gt;</span><span>修改用户</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/Lmonkeyshop/manage/admin_douserupdate" method="post" id="myform" name="myform" >
